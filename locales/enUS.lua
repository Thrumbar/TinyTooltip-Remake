...
local T = {
    ...
    ["general.announcements.dropdown.noticeAlways"] = "Always show announcements",
    ["general.announcements.dropdown.noticeNever"] = "Never show announcements",
    ["general.announcements.dropdown.noticeSnooze"] = "Show once per announcement update",
