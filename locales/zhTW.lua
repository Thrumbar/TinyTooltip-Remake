...
local T = {
    ...
    ["general.announcements"] = "公告訊息",
    ["general.announcements.dropdown.noticeAlways"] = "始終顯示公告訊息",
    ["general.announcements.dropdown.noticeNever"] = "永不顯示公告訊息",
    ["general.announcements.dropdown.noticeSnooze"] = "每次公告更新時僅顯示一次",
